...
class TaskController extends Controller
{
    ...
    public function Adminstore(Request $request)
    {
        ...
        return redirect('/admin/addnewtask/second');
    }
    ...
    public function AdminstoreFinalForm(Request $request)
    {
    ...
    public function adminvieweoncetTask($id)
    {
        ...
        return view('OnlyviewTask', compact('task', 'funding', 'expense', 'subaction_name', 'action_name', 'strategy_name', 'objective_name', 'goal_name'));
    }
