                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <label class="label warning-breadcrumb" style="width:20px; height:20px"><i class="icofont icofont-eye-alt f-20"></i></label>
                                                    <label class="label bg-success" style="width: 20px; height: 20px; display: inline-flex; align-items: center; justify-content: center; border-radius: 5px; padding-top: 7px;" > <i class="icofont icofont-pencil-alt-5"></i> </label>
