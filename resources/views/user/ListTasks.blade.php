                                        ...
                                        @foreach ($tasks as $task)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <label class="label bg-success" onclick="TaskEdit({{ $task->id }})"
                                                    ...
                                                    <span class="label" onclick="Taskupdate({{ $task->id }})"
                                                        style="display: inline-flex; align-items: center; justify-content: center; width: 20px; height: 20px; border-radius: 5px; margin: 5px; cursor: pointer; text-align: center; background-color: #8B7500;">
                                                        <i class="fas fa-sync" style="font-size: 16px; color: white;"></i>
